...
namespace Cerulean.CLI
{
    internal static class Snippets
    {
            ...
            IEnumerable<string> importStrings, IDictionary<string, string> aliasStrings, string? parent = null)
        {
            ...
            stringBuilder.AppendIndented(1, $"public partial class {className}{(parent is not null ? " : " + parent : "")}\n");
        ...
        public static void WriteClassFooter(StringBuilder stringBuilder)
        {
            stringBuilder.AppendIndented(1, "}\n");
            stringBuilder.AppendLine("}");
            stringBuilder.AppendLine("#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.");
